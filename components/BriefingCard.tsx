          ...
          <div className="flex items-center gap-2.5 flex-wrap">
            {lm && classification.label && (
              <div className="flex flex-col gap-0.5">
                ...
                <span title={lm.title} className="inline-flex items-center text-xs font-bold px-2.5 py-1 rounded cursor-help"
            ...
            {classification.assignedTo && (
              <div className="flex flex-col gap-0.5">
                ...
                <span className="inline-flex items-center gap-1.5 text-[11px] font-bold px-2.5 py-1 rounded-full tracking-[0.04em] uppercase"
                  style={{
